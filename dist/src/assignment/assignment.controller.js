...
let AssignmentController = class AssignmentController {
    ...
    assignSupport(req, caseId) {
        return this.assignmentService.assignSupport(caseId, req.user.sub);
    }
    alertLawyer(req, caseId) {
        return this.assignmentService.alertLawyer(caseId, req.user.sub);
    }
    lawyerAccept(req, caseId) {
        return this.assignmentService.lawyerAccept(caseId, req.user.sub);
    }
};
exports.AssignmentController = AssignmentController;
__decorate([
    (0, common_1.Post)('support/:caseId'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('caseId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], AssignmentController.prototype, "assignSupport", null);
__decorate([
    (0, common_1.Post)('lawyer/:caseId'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('caseId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], AssignmentController.prototype, "alertLawyer", null);
__decorate([
    (0, common_1.Patch)('lawyer/:caseId/accept'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('caseId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], AssignmentController.prototype, "lawyerAccept", null);
